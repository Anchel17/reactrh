        ...
        <div className="bg-[url('./assets/login-background.png')] bg-no-repeat bg-center sm:bg-top bg-cover w-[100vw] h-[100vh] flex justify-center items-center">
            <div className='bg-white flex flex-col w-72 rounded-xl sm:w-96 pb-7'>
                ...
                <form action={login} className='flex flex-col gap-4 items-center pt-5'>
                    <input className="border border-gray-400 w-[75%] sm:w-[50%] p-2" type="text" placeholder="Usuário" required/>
                    <input className="border border-gray-400 w-[75%] sm:w-[50%] p-2" type="password" placeholder="Senha" required/>
                ...
                <a href="/register" className="text-center text-blue-700">crie uma conta</a>
            </div>
        </div>
    )
}
